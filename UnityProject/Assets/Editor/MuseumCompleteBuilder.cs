...
namespace MuseumModerna
{
    ...
    public class MuseumCompleteBuilder : EditorWindow
    {
        ...
        List<ExhibitTpl> AllTemplates() => new List<ExhibitTpl>
        {
            // ── FOYER (leste e oeste) ──────────────────────────────────────────
            new ExhibitTpl
            {
                id = "semana_1922", year = 1922, movement = "Modernismo Brasileiro",
                title  = "Semana de Arte Moderna de 1922",
                artist = "Organização: Di Cavalcanti · Mário de Andrade · Graça Aranha",
                description =
                    "Realizada entre 13 e 17 de fevereiro de 1922 no Teatro Municipal de São Paulo, " +
                    "a Semana de Arte Moderna marcou a ruptura com o conservadorismo artístico e o " +
                    "início do Modernismo no Brasil. O evento reuniu pintores, escultores, poetas e " +
                    "músicos que buscavam uma arte genuinamente brasileira, livre das cópias do século XIX.",
                funFact = "'As vaias foram o maior elogio que poderíamos receber.' — Emílio di Cavalcanti",
                color = new Color(0.70f, 0.50f, 0.20f)
            },
            new ExhibitTpl
            {
                id = "organizadores", year = 1922, movement = "Modernismo",
                title  = "Os Organizadores da Semana",
                artist = "Emílio di Cavalcanti — artista e idealizador",
                description =
                    "Di Cavalcanti foi o principal articulador da Semana, convencendo Graça Aranha " +
                    "(escritor consagrado da ABL) a abrir o evento no Teatro Municipal. Mário de Andrade " +
                    "trouxe a dimensão literária e musical. Paulo Prado financiou o evento. " +
                    "Juntos, eles transformaram uma noite de gala burguesa num manifesto revolucionário.",
                funFact = "Di Cavalcanti criou a capa do programa da Semana — hoje um ícone do design gráfico brasileiro.",
                color = new Color(0.40f, 0.30f, 0.60f)
            },
            new ExhibitTpl
            {
                id = "villa_lobos_dancas", year = 1914, movement = "Modernismo Musical",
                title  = "Danças Africanas — Performance",
                artist = "Heitor Villa-Lobos",
                description =
                    "Villa-Lobos apresentou na Semana suas composições mais revolucionárias. " +
                    "Entrando ao palco de sapatos diferentes nos dois pés, desafiou a etiqueta do " +
                    "concerto clássico. As Danças Africanas incorporam ritmos populares brasileiros " +
                    "à linguagem da música erudita europeia.",
                funFact = "'Não aprendi, investiguei.' — Heitor Villa-Lobos.",
                color = new Color(0.70f, 0.30f, 0.50f)
            },
            new ExhibitTpl
            {
                id = "villa_lobos_lenda", year = 1920, movement = "Nacionalismo Musical",
                title  = "Lenda do Caboclo",
                artist = "Heitor Villa-Lobos",
                description =
                    "Uma das peças para piano que Villa-Lobos apresentou na Semana. A obra captura " +
                    "a atmosfera do interior brasileiro — o caboclo (mestiço de branco e índio) como " +
                    "figura mítica — através de uma linguagem que funde tradição europeia e melodia popular.",
                funFact = "Villa-Lobos compôs mais de 2.000 obras, tornando-se o compositor mais prolífico das Américas.",
                color = new Color(0.45f, 0.60f, 0.70f)
            },

            // ── HALL (ao lado da porta sul) ────────────────────────────────────
            new ExhibitTpl
            {
                id = "teatro_municipal", year = 1922, movement = "Contexto Histórico",
                title  = "Teatro Municipal de São Paulo",
                artist = "Arquitetura: Domiziano Rossi e Cláudio Rossi (1911)",
                description =
                    "O maior teatro da cidade e símbolo da elite paulistana foi deliberadamente " +
                    "escolhido pelos modernistas para provocar o establishment cultural. " +
                    "A ironia era central: usar o espaço mais conservador para promover a arte mais radical. " +
                    "Inaugurado em 1911, o teatro custou mais de 3 milhões de francos-ouro.",
                funFact = "Villa-Lobos entrou ao palco de sapatos diferentes — gesto proposital para provocar a plateia.",
                color = new Color(0.60f, 0.50f, 0.30f)
            },
            new ExhibitTpl
            {
                id = "manifesto_pau_brasil", year = 1924, movement = "Pau-Brasil",
                title  = "Manifesto da Poesia Pau-Brasil",
                artist = "Oswald de Andrade",
                description =
                    "Publicado dois anos após a Semana, o Manifesto Pau-Brasil crystallizou os ideais " +
                    "do movimento: exportar cultura originalmente brasileira em vez de importar modelos " +
                    "europeus. Pau-brasil, madeira explorada desde o século XVI, torna-se metáfora da " +
                    "riqueza cultural nativa que precisava ser redescoberta.",
                funFact = "'A poesia existe nos fatos.' — Oswald de Andrade, 1924.",
                color = new Color(0.20f, 0.55f, 0.25f)
            },

            // ── ALA PINTURA — parede norte (fundo) ────────────────────────────
            new ExhibitTpl
            {
                id = "homem_amarelo", year = 1916, movement = "Expressionismo",
                title  = "O Homem Amarelo",
                artist = "Anita Malfatti",
                description =
                    "Uma das obras mais radicais de Anita, O Homem Amarelo demonstra o domínio das " +
                    "técnicas expressionistas aprendidas na Alemanha e em Nova York. As cores " +
                    "anti-naturalistas — rosto amarelo-esverdeado, olhos azuis intensos — foram " +
                    "consideradas um escândalo pela crítica de São Paulo em 1917.",
                funFact = "O crítico Monteiro Lobato atacou esta obra em 'Paranoia ou Mistificação?' (1917), tornando Anita a heroína do Modernismo.",
                color = new Color(0.88f, 0.75f, 0.10f)
            },
            new ExhibitTpl
            {
                id = "estudante_russa", year = 1915, movement = "Expressionismo",
                title  = "A Estudante Russa",
                artist = "Anita Malfatti",
                description =
                    "Pintada em Nova York durante os estudos com Homer Boss, A Estudante Russa retrata " +
                    "uma mulher com formas angulares e pinceladas espessas. O retrato psicológico intenso " +
                    "reflete a influência do fauvismo francês e do expressionismo alemão que Anita " +
                    "absorveu durante anos de estudos na Europa e nos Estados Unidos.",
                funFact = "Anita foi a primeira artista brasileira a estudar Arte Moderna sistematicamente na Europa e nos EUA.",
                color = new Color(0.75f, 0.35f, 0.15f)
            },
            new ExhibitTpl
            {
                id = "tropical", year = 1917, movement = "Expressionismo",
                title  = "Tropical",
                artist = "Anita Malfatti",
                description =
                    "Em Tropical, Anita cria uma paisagem brasileira com cores saturadas e vibrantes. " +
                    "A vegetação densa e exuberante é tratada com a liberdade formal do expressionismo — " +
                    "formas simplificadas e cores emocionalmente intensas, não meramente descritivas. " +
                    "A obra celebra o trópico como experiência sensorial radical.",
                funFact = "Esta obra foi exposta na polêmica exposição de 1917 que gerou o artigo destruidor de Monteiro Lobato.",
                color = new Color(0.20f, 0.60f, 0.15f)
            },
            new ExhibitTpl
            {
                id = "di_cavalcanti_pierrot", year = 1922, movement = "Modernismo",
                title  = "Pierrot",
                artist = "Emílio di Cavalcanti",
                description =
                    "Di Cavalcanti usa a figura do Pierrot — o palhaço melancólico da Commedia " +
                    "dell'Arte — como metáfora do artista incompreendido pela sociedade. " +
                    "A obra mescla influências do cubismo parisiense com uma sensibilidade " +
                    "tropical e carioca inconfundível.",
                funFact = "Di Cavalcanti era carioca e trouxe para a Semana a perspectiva do Rio, equilibrando o paulicentrismo do grupo.",
                color = new Color(0.15f, 0.35f, 0.70f)
            },

            // ── ALA PINTURA — paredes leste e oeste ────────────────────────────
            new ExhibitTpl
            {
                id = "lasar_segall", year = 1918, movement = "Expressionismo",
                title  = "Prisioneiro",
                artist = "Lasar Segall",
                description =
                    "Lasar Segall, artista lituano radicado no Brasil, trouxe para São Paulo as " +
                    "técnicas expressionistas europeias. Prisioneiro retrata com angústia a condição " +
                    "humana aprisionada — leitura possível como metáfora da imigração e do exílio " +
                    "que o próprio artista vivenciou.",
                funFact = "Segall realizou a primeira exposição de Arte Moderna no Brasil em 1913 — antes da Semana de 22.",
                color = new Color(0.25f, 0.20f, 0.40f)
            },
            new ExhibitTpl
            {
                id = "john_graz", year = 1922, movement = "Modernismo",
                title  = "Composição — Figura Feminina",
                artist = "John Graz",
                description =
                    "John Graz, suíço naturalizado brasileiro, participou da Semana com obras que " +
                    "sintetizavam o cubismo francês com uma paleta mediterrânea. Sua produção " +
                    "posterior influenciou profundamente o design de interiores e a arte decorativa " +
                    "brasileira das décadas de 1920 e 1930.",
                funFact = "John Graz era cunhado de Tarsila do Amaral, estreitando os laços entre os grupos modernistas.",
                color = new Color(0.65f, 0.50f, 0.40f)
            },

            // ── ALA ESCULTURA ──────────────────────────────────────────────────
            new ExhibitTpl
            {
                id = "brecheret_cabeca_cristo", year = 1921, movement = "Modernismo / Art Déco",
                title  = "Cabeça de Cristo",
                artist = "Victor Brecheret",
                description =
                    "Victor Brecheret foi o grande escultor da Semana de Arte Moderna. Cabeça de Cristo " +
                    "exemplifica sua síntese entre o Art Déco e a espiritualidade brasileira. As linhas " +
                    "simplificadas e a expressividade monumental marcam uma ruptura definitiva com o " +
                    "realismo acadêmico da escultura oitocentista.",
                funFact = "Brecheret foi descoberto por Mário de Andrade em 1920, num ateliê improvisado numa garagem do Palácio das Indústrias.",
                color = new Color(0.70f, 0.65f, 0.55f)
            },
            new ExhibitTpl
            {
                id = "brecheret_eva", year = 1922, movement = "Modernismo",
                title  = "Eva",
                artist = "Victor Brecheret",
                description =
                    "Na escultura Eva, Brecheret explora o corpo feminino com uma estilização que " +
                    "recusa o naturalismo acadêmico. A figura sinuosa e geometrizada dialoga com a " +
                    "escultura africana e a arte pré-colombiana — fontes que os modernistas brasileiros " +
                    "reivindicavam como parte de uma identidade estética própria.",
                funFact = "As esculturas de Brecheret foram transportadas às pressas para o Teatro Municipal nas vésperas da Semana.",
                color = new Color(0.80f, 0.72f, 0.60f)
            },
            new ExhibitTpl
            {
                id = "brecheret_bandeiras", year = 1920, movement = "Modernismo Monumental",
                title  = "Monumento às Bandeiras — Estudo Preliminar",
                artist = "Victor Brecheret",
                description =
                    "O estudo para o Monumento às Bandeiras é uma das obras mais ambiciosas da arte " +
                    "brasileira. Brecheret propõe um grupo escultórico monumental retratando os " +
                    "bandeirantes com uma força épica e uma estilização modernista que rompe com os " +
                    "monumentos historicistas do século XIX.",
                funFact = "O Monumento só foi inaugurado no Parque do Ibirapuera em 1953 — mais de 30 anos após o primeiro estudo.",
                color = new Color(0.55f, 0.50f, 0.45f)
            },
            new ExhibitTpl
            {
                id = "brecheret_moema", year = 1921, movement = "Modernismo",
                title  = "Moema",
                artist = "Victor Brecheret",
                description =
                    "Inspirado no poema épico 'Caramuru' (1781) de Santa Rita Durão, Moema retrata " +
                    "a índia Tapiuia que morreu afogada perseguindo o navegador que a abandonou. " +
                    "Brecheret transforma o tema romântico numa composição Art Déco de intensa " +
                    "dramaticidade horizontal.",
                funFact = "Brecheret tratou o tema indígena com dignidade e monumentalidade, revolucionário para a época.",
                color = new Color(0.45f, 0.38f, 0.32f)
            },

            // ── ALA LITERATURA ─────────────────────────────────────────────────
            new ExhibitTpl
            {
                id = "mario_ode_burgues", year = 1922, movement = "Paulicéia Desvairada",
                title  = "Ode ao Burguês",
                artist = "Mário de Andrade",
                description =
                    "Lido na noite de abertura da Semana, é um ataque feroz ao conservadorismo da " +
                    "elite paulistana: 'Eu insulto o burguês! O burguês-níquel, o burguês-burguês! / " +
                    "A digestão bem feita de São Paulo! / O homem-curva! O homem-nádegas! / " +
                    "Prazer do burguês: a solidez dos valores...'",
                funFact = "Mário recitou este poema durante a Semana, provocando escândalo tão grande que a polícia foi chamada ao Teatro.",
                color = new Color(0.80f, 0.20f, 0.15f)
            },
            new ExhibitTpl
            {
                id = "mario_pauliceia", year = 1922, movement = "Modernismo",
                title  = "Prefácio Interessantíssimo — Paulicéia Desvairada",
                artist = "Mário de Andrade",
                description =
                    "No Prefácio Interessantíssimo, Mário define sua poética da harmonia polifônica " +
                    "e do verso livre: 'Quando sinto a impulsão lírica, escrevo sem pensar tudo o " +
                    "que meu inconsciente grita. Penso depois.' A obra inaugura o verso livre, " +
                    "o ritmo emocional e a pluralidade de vozes como recursos da poesia brasileira.",
                funFact = "Mário começou a escrever Paulicéia Desvairada numa única noite de dezembro de 1920, em estado de inspiração febril.",
                color = new Color(0.85f, 0.75f, 0.30f)
            },
            new ExhibitTpl
            {
                id = "oswald_poemas", year = 1922, movement = "Modernismo",
                title  = "Poemas — Brazilwood",
                artist = "Oswald de Andrade",
                description =
                    "Oswald usou na Semana sua técnica de extrema condensação — poemas-telegrama, " +
                    "poemas-piada. Exemplo: 'Erro de Português': 'Quando o português chegou / " +
                    "Debaixo duma bruta chuva / Vestiu o índio / Que pena! / Fosse uma manhã de sol / " +
                    "O índio tinha despido / O português.'",
                funFact = "Oswald e Mário: o extrovertido provocador vs. o introspectivo erudito — os dois polos do Modernismo brasileiro.",
                color = new Color(0.30f, 0.55f, 0.75f)
            },
            new ExhibitTpl
            {
                id = "graca_aranha_discurso", year = 1922, movement = "Modernismo",
                title  = "A Emoção Estética na Arte Moderna",
                artist = "Graça Aranha",
                description =
                    "Graça Aranha abriu a Semana com um discurso propondo a ruptura com a Academia " +
                    "Brasileira de Letras e a criação de uma arte brasileira cosmopolita e livre. " +
                    "Sua autoridade literária — era membro fundador da ABL — legitimou o evento " +
                    "junto à elite cultural de São Paulo.",
                funFact = "Graça Aranha tinha 56 anos em 1922 — o mais velho do grupo. Seu prestígio viabilizou o Teatro Municipal.",
                color = new Color(0.40f, 0.60f, 0.45f)
            },
            new ExhibitTpl
            {
                id = "ronald_carvalho", year = 1922, movement = "Modernismo",
                title  = "Poemas — Toda a América",
                artist = "Ronald de Carvalho",
                description =
                    "Ronald de Carvalho foi o único participante que integrou tanto a Semana de 22 " +
                    "quanto os modernistas cariocas, servindo de ponte entre os dois centros culturais. " +
                    "Em 'Toda a América', busca uma epopeia pan-americana que celebre as origens " +
                    "indígenas e a natureza exuberante do continente.",
                funFact = "Ronald de Carvalho foi um dos primeiros a traduzir Guillaume Apollinaire para o português.",
                color = new Color(0.50f, 0.35f, 0.60f)
            },
        };
